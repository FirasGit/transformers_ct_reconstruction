"""
Adapted from: https://github.com/karpathy/nanoGPT and https://github.com/dome272/VQGAN-pytorch
...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        if not self.flash:
            print("WARNING: using slow attention. Flash Attention atm needs PyTorch >= 2.0")
